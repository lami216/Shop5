...
const PurchaseSuccessPage = () => {
        ...
        if (error)
                return (
                        <div className='flex h-screen items-center justify-center bg-brand-surface text-payzone-gold'>
        ...
        return (
                <div className='min-h-screen bg-brand-surface px-4 py-10 text-payzone-gold sm:py-16' dir='rtl'>
                        <div className='mx-auto w-full max-w-4xl'>
                                ...
                                <section className='rounded-3xl bg-white/95 p-6 shadow-xl ring-1 ring-black/5 sm:p-10'>
                                        <div className='flex flex-col items-center text-center'>
                                                ...
                                                <p className='mt-3 max-w-2xl text-base text-payzone-gold/70 sm:text-lg'>{description}</p>
                                        </div>
                                        ...
                                        {orderDetails?.orderNumber && (
                                                <div className='mt-6 flex justify-center'>
                                                        <div className='rounded-2xl border border-[#e5d4d8] bg-white px-6 py-3 text-center text-payzone-gold shadow-sm'>
                                                                ...
                                                                <div className='mt-1 text-xs text-payzone-gold/70'>
                                                ...
                                                {orderDetails ? (
                                                        <>
                                                                <div className='rounded-2xl border border-payzone-navy/10 bg-white p-5 shadow-sm sm:p-6'>
                                                                        <div className='text-sm font-semibold text-payzone-gold/50'>
                                                                                {t("purchase.success.details.customer")}
                                                                        </div>
                                                                        <div className='mt-4 space-y-3 text-right text-base font-medium'>
                                                                                <div className='flex items-baseline justify-between gap-4'>
                                                                                        <span className='text-payzone-gold/50'>
                                                                                                {t("purchase.success.details.name")}
                                                                                        </span>
                                                                                        <span className='flex-1 text-left text-payzone-gold'>{orderDetails?.customerName || "-"}</span>
                                                                                </div>
                                                                                <div className='flex items-baseline justify-between gap-4'>
                                                                                        <span className='text-payzone-gold/50'>
                                                                                                {t("purchase.success.details.phone")}
                                                                                        </span>
                                                                                        <span className='flex-1 text-left text-payzone-gold'>{orderDetails?.phone || "-"}</span>
                                                                                </div>
                                                                                <div className='flex items-baseline justify-between gap-4'>
                                                                                        <span className='text-payzone-gold/50'>
                                                                                                {t("purchase.success.details.address")}
                                                                                        </span>
                                                                                        <span className='flex-1 text-left text-payzone-gold'>{orderDetails?.address || "-"}</span>
                                                                                </div>
                                                                        </div>
                                                                </div>
                                                                ...
                                                                <div className='overflow-hidden rounded-2xl border border-payzone-navy/15 bg-white shadow-sm'>
                                                                        <table className='min-w-full border-collapse text-right text-sm sm:text-base'>
                                                                                <thead className='bg-payzone-navy/5 text-payzone-gold/70'>
                                                                                        <tr>
                                                                                ...
                                                                                <tbody className='text-payzone-gold'>
                                                                                        {storedItems.length > 0 ? (
                                                                                                storedItems.map((item) => {
                                                                                                        ...
                                                                                                        return (
                                                                                                                ...
                                                                                                                >
                                                                                                                        <td className='px-4 py-4 align-middle'>
                                                                                                                                <div className='flex justify-center'>
                                                                                                                                        {item.image ? (
                                                                                                                                                ...
                                                                                                                                                <div className='grid h-16 w-16 place-items-center rounded-lg bg-payzone-navy/10 text-payzone-gold/40'>
                                                                                                                        ...
                                                                                                                        <td className='px-4 py-4 align-middle text-left text-payzone-gold/70'>
                                                                                                                                <div className='flex flex-col items-start'>
                                                                                                                                        {isDiscounted && (
                                                                                                                                                <span className='text-xs text-payzone-gold/50 line-through'>
                                                                                                ...
                                                                                                <tr>
                                                                                                        <td colSpan={5} className='px-4 py-6 text-center text-payzone-gold/50'>
                                                                ...
                                                                <div className='rounded-2xl border border-payzone-navy/15 bg-white p-5 shadow-sm sm:p-6'>
                                                                        <div className='flex items-center justify-between text-base text-payzone-gold/70'>
                                                                                <span>{t("purchase.success.details.countLabel")}</span>
                                                                                <span className='text-lg font-semibold text-payzone-gold'>{formatNumberEn(totalCount)}</span>
                                                                        </div>
                                                                        <div className='mt-3 flex items-center justify-between border-t border-payzone-navy/10 pt-3 text-base text-payzone-gold/70'>
                                                                                <span>{t("purchase.success.details.grandTotalLabel")}</span>
                                                                                <span className='text-lg font-semibold text-payzone-gold'>{formatMRU(totalAmount)}</span>
                                                                        </div>
                                                                </div>
                                                        </>
                                                ) : (
                                                        <div className='rounded-2xl border border-payzone-navy/15 bg-white p-6 text-center text-payzone-gold/70'>
