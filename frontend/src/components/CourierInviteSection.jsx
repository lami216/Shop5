                ...
                <section className='border-t border-brand-border bg-payzone-white/90' aria-label='انضمام الموصّلين'>
                        <div className='mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 py-10 text-center sm:flex-row sm:text-right' dir='rtl'>
                                <div className='space-y-2 sm:text-right'>
                                        <p className='text-xs font-semibold uppercase tracking-[0.3em] text-payzone-gold/60'>فرصة عمل</p>
                                        <h2 className='text-2xl font-bold text-payzone-gold sm:text-3xl'>معك دراجة وتحب تشتغل توصيل؟</h2>
                                        <p className='max-w-3xl text-base text-payzone-gold/80 sm:text-lg'>
                                ...
                                <div className='flex w-full justify-center sm:w-auto'>
                                        ...
                                        >
                                                <span className='whitespace-nowrap text-payzone-gold'>انضم لطاقم التوصيل</span>
                                                <Bike className='h-5 w-5 text-payzone-gold transition-transform duration-500 ease-out group-hover:translate-y-[-2px] group-hover:scale-110 group-active:translate-y-[-1px]' />
                                        </Link>
                                </div>
                        </div>
                </section>
