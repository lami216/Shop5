...
const AdminOrders = () => {
        ...
        if (loading) {
                return (
                        <div className='flex justify-center py-16 text-payzone-gold/80'>
        ...
        if (!orders.length) {
                return (
                        <motion.div
                                className='rounded-xl border border-white/10 bg-white/5 p-8 text-center text-payzone-gold/70'
        ...
        return (
                <motion.div
                        className='space-y-6 rounded-xl border border-payzone-indigo/40 bg-white/5 p-6 text-payzone-gold shadow-lg backdrop-blur-sm'
                ...
                >
                        ...
                        <div className='overflow-x-auto'>
                                <table className='min-w-full divide-y divide-white/10 text-right text-sm text-payzone-gold'>
                                        <thead className='bg-payzone-navy/60 text-xs uppercase tracking-wide text-payzone-gold/60'>
                                                <tr>
                                                                ...
                                                                <tr key={order._id} className='bg-white/5 hover:bg-white/10'>
                                                                        ...
                                                                        <td className='px-4 py-4 align-middle'>
                                                                                <div className='flex flex-col text-sm'>
                                                                                        ...
                                                                                        <span className='text-xs text-payzone-gold/70'>
                                                                                                {order.phone}
                                                                                        </span>
                                                                                </div>
                                                                        </td>
                                                                        <td className='px-4 py-4 align-middle'>
                                                                                <div className='flex flex-col items-end'>
                                                                                        <span className='font-semibold text-payzone-gold'>{formattedTotal}</span>
                                                                                        <span className='text-xs text-payzone-gold/60'>
                                                                        ...
                                                                        <td className='px-4 py-4 align-middle'>
                                                                                <select
                                                                                        className='min-w-[10rem] rounded-lg border border-white/20 bg-payzone-navy/60 px-3 py-2 text-sm text-payzone-gold focus:border-payzone-gold focus:outline-none'
                                                                                        value={order.status}
                                                                        ...
                                                                        <td className='px-4 py-4 align-middle text-sm text-payzone-gold/80'>
                                                                                {createdAt}
                                                                        </td>
