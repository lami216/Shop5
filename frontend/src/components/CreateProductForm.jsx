        ...
        return (
                ...
                >
                        <div className='mb-6 flex items-start justify-between gap-4'>
                                ...
                                {isEditing && (
                                        <button
                                                type='button'
                                                onClick={resetForm}
                                                className='inline-flex items-center gap-2 rounded-md border border-payzone-indigo/40 px-3 py-1 text-sm text-[#4A3524] transition hover:border-payzone-gold'
                                        >
                                                <X className='h-4 w-4' />
                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                                <div>
                                        <label htmlFor='name' className='block text-sm font-medium text-[#4A3524]/80'>
                                        ...
                                        <input
                                                ...
                                                className='mt-1 block w-full rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-[#4A3524] placeholder-[#4A3524]/40 focus:border-payzone-gold focus:outline-none focus:ring-2 focus:ring-payzone-indigo'
                                                required
                                        />
                                </div>

                                <div>
                                        <label htmlFor='description' className='block text-sm font-medium text-[#4A3524]/80'>
                                ...
                                <div>
                                        <label htmlFor='price' className='block text-sm font-medium text-[#4A3524]/80'>
                                        ...
                                        <div className='flex items-start justify-between gap-4'>
                                                <div>
                                                        <label
                                                                ...
                                                                className='text-sm font-medium text-[#4A3524]/80'
                                                        >
                                        ...
                                        {formState.isDiscounted && (
                                                <div className='mt-4 space-y-2'>
                                                        <label
                                                                ...
                                                                className='block text-sm font-medium text-[#4A3524]/80'
                                                        >
                                ...
                                <div>
                                        <label htmlFor='category' className='block text-sm font-medium text-[#4A3524]/80'>
                                        ...
                                        <select
                                                ...
                                                className='mt-1 block w-full rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-[#4A3524] focus:border-payzone-gold focus:outline-none focus:ring-2 focus:ring-payzone-indigo'
                                                required
                                        >
                                                <option value=''>
                                ...
                                <div className='mt-1 flex items-center'>
                                        ...
                                        <label
                                                htmlFor='images'
                                                className={`inline-flex items-center gap-2 rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-sm font-medium text-[#4A3524] transition duration-300 focus:outline-none focus:ring-2 focus:ring-payzone-indigo ${
                                        ...
                                        <span className='mr-3 text-sm text-[#4A3524]/60'>
                                                ...
                                                {galleryItems.map((item) => {
                                                        ...
                                                        return (
                                                                ...
                                                                >
                                                                        ...
                                                                        />
                                                                        <div className='absolute inset-x-0 bottom-0 flex items-center justify-between bg-black/60 px-2 py-1 text-xs text-[#4A3524]'>
                                                                                <button
                                                                                        type='button'
