        ...
        return (
                ...
                >
                        ...
                        <form onSubmit={handleSubmit} className='space-y-4'>
                                <div>
                                        <label htmlFor='name' className='block text-sm font-medium text-payzone-gold/80'>
                                ...
                                <div>
                                        <label htmlFor='description' className='block text-sm font-medium text-payzone-gold/80'>
                                ...
                                <div>
                                        <label htmlFor='price' className='block text-sm font-medium text-payzone-gold/80'>
                                        ...
                                        <div className='flex items-start justify-between gap-4'>
                                                <div>
                                                        <label
                                                                ...
                                                                className='text-sm font-medium text-payzone-gold/80'
                                                        >
                                        ...
                                        {formState.isDiscounted && (
                                                <div className='mt-4 space-y-2'>
                                                        <label
                                                                ...
                                                                className='block text-sm font-medium text-payzone-gold/80'
                                                        >
                                ...
                                <div>
                                        <label htmlFor='category' className='block text-sm font-medium text-payzone-gold/80'>
                                ...
                                <div className='mt-1 flex items-center'>
                                        ...
                                        <label
                                                htmlFor='images'
                                                className={`inline-flex items-center gap-2 rounded-md border border-payzone-indigo/40 bg-payzone-navy/60 px-3 py-2 text-sm font-medium text-payzone-gold transition duration-300 focus:outline-none focus:ring-2 focus:ring-payzone-indigo ${
                                        ...
                                        <span className='mr-3 text-sm text-payzone-gold/60'>
                                                ...
                                                {galleryItems.map((item) => {
                                                        ...
                                                        return (
                                                                ...
                                                                >
                                                                        ...
                                                                        />
                                                                        <div className='absolute inset-x-0 bottom-0 flex items-center justify-between bg-black/60 px-2 py-1 text-xs text-payzone-gold'>
                                                                                <button
                                                                                        type='button'
                                ...
                                <button
                                        type='submit'
                                        className='flex w-full items-center justify-center gap-2 rounded-md bg-payzone-gold px-4 py-2 text-sm font-semibold text-black transition duration-300 hover:bg-[#222222] focus:outline-none focus:ring-2 focus:ring-payzone-indigo/60 disabled:opacity-50'
